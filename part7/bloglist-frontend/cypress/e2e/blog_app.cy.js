describe("Blog App Test", () => {
  ...
  describe("Login test", function () {
    ...
    it("Successful login", function () {
      ...
      cy.get("html").should("contain", "User Test1 logged in");
    });
  });
  ...
  describe("After logged in", function () {
    ...
    it("User can like a blog", function () {
      ...
      cy.contains("Secound Blog").parent().find("#like").click();

      cy.contains("Secound Blog").parent().contains("likes: 1");
    });

    it("User who created blog can delete it", function () {
      cy.contains("First Blog").contains("show").click();

      cy.contains("First Blog").parent().find("#delete").click();
    ...
    it("User who not created blog can not delete it", function () {
      ...
      cy.contains("Secound Blog").parent().should("not.contain", "#delete");
    });
